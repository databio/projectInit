...
2. Populates an output variable to ${PROCESSED}/project_name

3. Runs a project-specific R init script, if you have one saved at `${CODE}/project_name/00-init.R`.

4. Populates a project-level cache directory at `${PROCESSED}/project_name/RCache`. This variable is read as the default by R package `simpleCache`, so your caches will now be stored in a specified cache directory for this project.
