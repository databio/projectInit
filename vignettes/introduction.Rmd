...
The second major thing done by the `projectInit()` function is that it sets global R variables to match your environment variables and provides a series of helper functions to locate input and direct output without worrying about file paths.
